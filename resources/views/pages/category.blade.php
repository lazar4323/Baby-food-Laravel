        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-title text-center">
                    <h3 style="margin-left: -500px;">Most Popular Menus</h3>
                    <ul class="breadcrumb">
                        <li style="margin-left: -300px;"><a href="{{ route('home') }}">Home</a></li>
                        <li>Menus</li>
                    </ul>
                </div>
            </div>
							...
							<div class="p-food-item">
								<div class="p-food-inner">
									...
									<div class="p-food-content">
										...
										<a href="{{ route('category.buyFood',['id'=>$card->id])}}" class="btn btn-success m-2 mb-3 " >Buy item</a>
