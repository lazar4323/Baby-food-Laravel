                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="active" href="menu-card.html">Category style 1</a></li>
        ...
        <section class="product style-2 bg-body padding-tb">
            <div class="container">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item"><a href="{{ route('showBurgers') }}">Burgers menu</a></li>
                    <li class="list-group-item"><a href="{{ route('showPorridge') }}">Porridge menu</a></li>
                    <li class="list-group-item"><a href="{{ route('showMilk') }}">Milk menu</a></li>
                    <li class="list-group-item"><a href="{{ route('showChocolate') }}">Chocolate menu</a></li>
                </ul>
        </section>
